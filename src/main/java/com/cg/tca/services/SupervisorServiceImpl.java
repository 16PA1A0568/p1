...
public class SupervisorServiceImpl implements SupervisorService {
	...
	/*
	 * public Supervisor updateSupervisor(@PathVariable(value = "id") Integer
	 * supervisorId,
	 * 
	 ...
	 * .orElseThrow(() -> new
	 * ResourceNotFoundException("Company Supervisor not found for this id :: " +
	 * supervisorId));
	 * supervisor.setSupervisorId(supervisorDetails.getSupervisorId());
	 * supervisor.setEmps(supervisorDetails.getEmps()); final Supervisor
	 * updatedManager = supervisorRepository.save(supervisor);
	 * 
	 ...
	 */
	@Override
	public Supervisor updateSupervisor(Integer supervisorId, Supervisor supervisorDetails)
			throws ResourceNotFoundException {
		Supervisor supervisor = supervisorRepository.findById(supervisorId)
				.orElseThrow(() -> new ResourceNotFoundException("Employee not found for this id :: " + supervisorId));
	...
	/*
	 * public Set<Employee> viewEmployeesBySupId(int supId) { Supervisor another =
	 * supervisorRepository.getOne(supId);
	 * 
	 * return another.getEmps(); }
	 */
	/*
	 * public List<Employee> viewEmployeeBySupId(int supId){ List<Employee>
	 * emp=supervisorRepository.findBySupId(supId); return emp; }
	 */
